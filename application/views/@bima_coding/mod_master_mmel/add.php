<div class="col-sm-12">
    <div class="white-box">
        ...
        <?php $attributes = array('class'=>'form-horizontal','role'=>'form','autocomplete'=>'off'); echo form_open_multipart('mmel/tambah_mmel',$attributes); ?>
            <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
            
            <div class="form-group row">
                <label for="example-text-input" class="col-2 col-form-label">Kode Inventaris</label>
                <div class="col-10">
                    <select class="form-control" name="id_inv" id="id_inv">
                        <option class="0">-- Pilih --</option>
                        <?php   
                            foreach ($inv as $key) {
                                echo "<option value='$key[id_inv]'>$key[noinv]</option>";
                            }
                        ?>
                    </select>
                </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-10">
                    <input class="form-control" type="text" name="harga_pengganti" id="harga_pengganti">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-10">
                    <input style="padding-bottom: 35px; padding-top: 2px" class="form-control" type="date" name="tanggal_penawaran">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-10">
                    <input class="form-control" type="text" id="biaya_pemeliharaan" name="biaya_pemeliharaan">
                </div>
            </div>
            <hr>
            <div id="div_hitung">
            ...
            <button type="submit" class="btn btn-success waves-effect waves-light m-r-10" name="submit"><i class="fa fa-refresh fa-spin" id="loader" style="display: none"></i> Kirim</button>
