...
<h1 style="color: #044366; font-style: bold; font-family: sans-serif; font-size: 50px;">RIWAYAT PEMELIHARAAN ALAT</h1>
                ...
                <tbody>
                    <?php
                        ...
                        foreach ($record as $row) {
                          if($row['inisial'] == 'Kalibrasi'){
                            $backgroundcolor = 'rgba(255, 99, 132, 0.2)';
                          }elseif($row['inisial'] == 'CM'){
                            $backgroundcolor = 'rgba(54, 162, 235, 0.2)';
                          }elseif($row['inisial'] == 'PM'){
  ...
  <?php
    ...
    foreach ($record_jenis as $row_jenis) {
        $labels = $labels.' " '.$row_jenis['inisial'].'",';
        $data_count = $this->db->query("SELECT * FROM t_datapemeliharaan bb 
                        ...
                        WHERE bb.id_jenis = '".$row_jenis['id_jenis']."' AND a.id_inv = '".$id_inv."'
                        ")->result_array();
