<div class="col-sm-12">
    <div class="white-box">
        ...
        <?php $attributes = array('class'=>'form-horizontal','role'=>'form','autocomplete'=>'off'); echo form_open_multipart('pemeliharaan/update_pemeliharaan',$attributes); ?>
        <?php
            $noinv = '';
            foreach($inv as $key){
        ...
        ?>
            ...
            <div class="form-group row">
                ...
                <div class="col-10">
                    <input class="form-control" type="text" name="tgl_perencanaan" value="<?=$row['tgl_pm']?>" readonly="">
                </div>
            </div>
