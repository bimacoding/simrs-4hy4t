<div class="col-sm-12">
    <div class="white-box">
        ...
        <?php $attributes = array('class'=>'form-horizontal','role'=>'form','autocomplete'=>'off'); echo form_open_multipart('siteman/ubah_kondisi',$attributes); ?>
            ...
            <div class="form-group row">
                ...
                <div class="col-10">
                    ...
                    <input class="form-control" type="text" value="<?=$row['nama_kondisi']?>" name="kondisi">
                </div>
            </div>
